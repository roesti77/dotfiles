...
temperature: 0.2
description: "Performs comprehensive UI testing for web and mobile applications. Use after UI implementation is complete to validate functionality, user flows, and edge cases."
---
...
<commentary>The agent will use Mobile...</commentary>
</example>
